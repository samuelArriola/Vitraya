<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateAreas.aspx.cs" Inherits="Generales_1._0.Home.dashboard.production.screens.general.CreateAreas" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    ...
    <title>Clinica Crecer | Gestionar Direcciones</title>
...
<body class="nav-md">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <asp:UpdatePanel runat="server" ID="updateSigla">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" MaxLength="3" OnTextChanged="TextBox4_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                                        ...
                                                                        <asp:GridView ID="GridArea" runat="server" CssClass="table table-striped jambo_table bulk_action" DataKeyNames="GnCdAra" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="false" OnRowCancelingEdit="GridArea_RowCancelingEdit" OnRowDeleting="GridArea_RowDeleting" OnRowEditing="GridArea_RowEditing" OnRowUpdating="GridArea_RowUpdating">
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField HeaderText="Codigo">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="TextBox1" runat="server" ReadOnly="true" Text='<%# Bind("GnCdAra") %>'></asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("GnCdAra") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Nombre">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("GnNomAra") %>' CssClass="form-control"></asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("GnNomAra") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Nombre">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("GnSiglaDr") %>' CssClass="form-control" MaxLength="3"></asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("GnSiglaDr") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
    ...
    <script src="../../../build/js/custom.min.js"></script>--%>
        ...
        <script>
            function erroDireccion() {
                new PNotify({
                    title: "On No!",
                    text: "Ingrese el nombre de la direccion",
                    type: "error",
                    styling: "bootstrap3",
                    delay: 1000
                });
            ...
            function Area() {
                new PNotify({
                    title: "On No!",
                    text: "Esta direccion ya se encuentra registrada, o se encuentra inactiva",
                    type: "error",
                    styling: "bootstrap3",
                    delay: 1000
                });
            ...
            function Sigla() {
                new PNotify({
                    title: "On No!",
                    text: "Esta sigla ya se encuentra en el sistema favor ingresar otra",
                    type: "error",
                    styling: "bootstrap3",
                    delay: 1000
                });
   ...
   $(function () {
    ...
    $("#datetimepicker7").on("dp.change", function(e) {
        ...
        <div runat="server" visible="false">
            ...
            <asp:Label ID="Label7" runat="server" Text="Label" Style="color: transparent"></asp:Label>
        </div>
    </form>
</body>
</html>
