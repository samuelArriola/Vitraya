<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Processes.aspx.cs" Inherits="Generales_1._0.Home.dashboard.production.screens.proceedings.WebForm1" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    ...
    <title>Clinica Crecer | Gestionar Procesos</title>
...
<body class="nav-md">
    <form id="form1" runat="server">
        <div class="container body">
           ...
           <Scripts>
               <asp:ScriptReference Path="../../../build/js/custom.min.js" />
               <asp:ScriptReference Path="../../../vendors/jquery/dist/jquery.min.js" />
               <asp:ScriptReference Path="../../../vendors/moment/min/moment.min.js" />
           </Scripts>
       </asp:ScriptManager>
                                                                        ...
                                                                        <asp:GridView ID="GridProcesos" runat="server" CssClass="table table-striped jambo_table bulk_action" DataKeyNames="GnOIdPrs" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="false" OnRowCancelingEdit="GridArea_RowCancelingEdit" OnRowDeleting="GridArea_RowDeleting" OnRowEditing="GridArea_RowEditing" OnRowUpdating="GridArea_RowUpdating">
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField HeaderText="Codigo">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="TextBox1" runat="server" ReadOnly="true" Text='<%# Bind("GnOIdPrs") %>'></asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("GnOIdPrs") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Nombre">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("GnNmPrs") %>' CssClass="form-control"></asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("GnNmPrs") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
        ...
        <script type="text/javascript">
         ...
         <script>
             function error() {
                 new PNotify({
                     title: "Oh No",
                     text: "Este Proceso ya se encuentra registrado",
                     type: "error",
                     styling: "bootstrap3",
                     delay: 1000
                 });
   ...
   $(function () {
    ...
    $("#datetimepicker7").on("dp.change", function(e) {
        ...
        <div runat="server" visible="false">
            <asp:Label ID="Label1" runat="server" Text="123" Style="color: transparent"></asp:Label>
            ...
            <asp:Label ID="Label10" runat="server" Text="Label" Style="color: transparent"></asp:Label>
        </div>
    </form>
</body>
</html>
