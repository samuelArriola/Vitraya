<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateCargos.aspx.cs" Inherits="Generales_1._0.Home.dashboard.production.screens.general.CreateCargos" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    ...
    <title>Clinica Crecer | Gestionar Cargos</title>
                                                        ...
                                                        <div class="row" style="overflow: scroll; height: 800px" id="DivAreaTrabajo">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:GridView ID="GridCargo" runat="server" AutoGenerateColumns="False" DataKeyNames="GnDcCgo" CellPadding="3" ForeColor="Black" GridLines="Vertical" CssClass="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" OnRowCancelingEdit="GridCargo_RowCancelingEdit" OnRowDeleting="GridCargo_RowDeleting" OnRowEditing="GridCargo_RowEditing" OnRowUpdating="GridCargo_RowUpdating" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px">
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField HeaderText="Codigo">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="TextBox1" runat="server" ReadOnly="true" Text='<%# Bind("GnDcCgo") %>'></asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("GnDcCgo") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Nombre">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("GnNomCgo") %>' CssClass="form-control"></asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("GnNomCgo") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>                                                                                
                                                                                <asp:TemplateField HeaderText="Unidad Funcional">
                                                                                    <EditItemTemplate>
                                                                                        <asp:DropDownList ID="DropDownList2" runat="server" DataTextField="GnNomDep" DataValueField="GnDcDep" DataSourceID="SqlCargarArea" CssClass="form-control"></asp:DropDownList>
                                                                                        <asp:SqlDataSource ID="SqlCargarArea" runat="server" ConnectionString="<%$ ConnectionStrings:default %>" SelectCommand="SELECT [GnNomDep],[GnDcDep] FROM [Departamento]"></asp:SqlDataSource>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("GnNomDep") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Sigla-Unidad Funcional">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("GnSiglaUnf") %>' CssClass="form-control" MaxLength="3" Enabled="false"></asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
    ...
    <script src="../../../build/js/custom.min.js"></script>--%>
        ...
        <script>
            ...
            function error2() {
                new PNotify({
                    title: "Oh No!",
                    text: "Ingrese el nombre del Cargo",
                    type: "error",
                    styling: "bootstrap3",
                    delay: 1000
                });
   ...
   $(function () {
    ...
    $("#datetimepicker7").on("dp.change", function(e) {
        ...
        <div runat="server" visible="false">
            ...
            <asp:Label ID="Label20" runat="server" Text="Label" Style="color: transparent"></asp:Label>
            <asp:Label ID="Label21" runat="server" Text="Label" Style="color: transparent"></asp:Label>
            <asp:Label ID="Label22" runat="server" Text="Label" Style="color: transparent"></asp:Label>
