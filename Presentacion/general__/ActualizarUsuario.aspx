<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarUsuario.aspx.cs" Inherits="Generales_1._0.Home.dashboard.production.screens.general.ActualizarUsuario" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-12">
                                            <div class="form-group text-right">
                                                <asp:Button Text="Actualizar Usuario" runat="server" CssClass="btn btn-success" ID="btnCrearUsuarios" OnClick="btnActualizarUsuario_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
