<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AprobarDocumento.aspx.cs" Inherits="Presentacion.GestionDocumental.AprobarDocumento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
            ...
            <div class="tableContainer">
                <table class="table">
                    <thead>
                        ...
                        <tr>
                            <th>
                                <input type="text" id="txtNomDoc" class="form-control" /></th>
                            <th>
                                <input type="text" id="txtTipDoc" class="form-control" /></th>
                            <th>
    ...
    <script src="js/AprobarDocumentoJS.js"></script>
</asp:Content>
