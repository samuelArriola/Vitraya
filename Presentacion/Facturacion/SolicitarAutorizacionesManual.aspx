<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SolicitarAutorizacionesManual.aspx.cs" Inherits="Presentacion.Facturacion.SolicitarAutorizacionesManual" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div class="col col-12">
             <div class="page-title">
                <div class="title_left">
                    <h3>Registro Manual de Solicitud de Autorización</h3>
                </div>
            </div>
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-5">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="numeroIngreso"/>
                            </div>
                        </div>
                        <div class="col col-1">
                                <div class="form-group">
                                    <button style="margin-top: 27px;" type="button" class="btnBuscarInfoIngreso btn btn-primary">BUSCAR</button>
                                </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col col-6">
                            <div class="form-group">
                                ...
                                <select id="tipoId" class="form-control form-select form-select-lg mb-3" aria-label=".form-select-sm example" readonly>
                        ...
                        <div class="col col-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="numId" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="x_title">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-6">
                            <div class="form-group">
                                <label>* 5. Fecha y Hora de Ingreso:</label>
    ...
    <script src="JS/RegistroAutorizacionesManualJS.js"></script>
