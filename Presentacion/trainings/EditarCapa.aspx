<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EditarCapa.aspx.cs" Inherits="Presentacion.trainings.EditarCapa" %>
        ...
        <div class="x_title">
            <div class="clearfix">
                <div class="d-flex justify-content-between">
                    <h6>Editar agenda</h6>
                    <div>
                        <button class="btn btn-primary" id="btnEditarMatricula">Editar matricula</button>
                        <button class="btn btn-primary" id="btnEditarExamen">Editar Examen</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="x_content">
            ...
            <div class="field item form-group justify-content-center mt-5">
                <div class="col col-6 d-flex justify-content-between">
                    ...
                    <button class="btn btn-success" id="btnActulizarAgenda" type="button">Actulizar Agenda</button>
                </div>
            </div>
        </div>
    </div>
    <script src="js/EditarCapaJS.js"></script>
</asp:Content>
