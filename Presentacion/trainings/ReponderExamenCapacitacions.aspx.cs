...
namespace Generales_1._0.Home.dashboard.production.screens.trainings
{
    public partial class ReponderExamenCapacitacion : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string responderExamenCapacitacion(CPEXAMENSOL examenSol)
        {
            int sumRespuestas = 0;
            CPEXAMEN examen = (CPEXAMEN)HttpContext.Current.Session["examen"];

            examenSol.IntIDMATRICULA = DAOCPMatricula.GetMatricula(Convert.ToInt32(HttpContext.Current.Session["Admin"].ToString()), examen.IntOidInstancia).IntOidCPMatricula;
