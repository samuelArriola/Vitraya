<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AddCapacitacion.aspx.cs" Inherits="Presentacion.trainings.AddCapacitacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div class="col col-12">
             <div class="page-title">
                <div class="title_center">
                    <h3>ADMINISTRAR MIS CAPACITACIONES</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col col-12 col-lg-3 p-0 d-none d-lg-inline-block" id="menuContainerTemas">
            <div class="" id="menuTemas">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <div class="clearfix">
                            <h6 class="text-center">Litado de Capacitaciones</h6>
                        </div>
                    </div>
                    <div class="x_content">
    ...
    <script src="js/AddCapacitacionJS.js"></script>
</asp:Content>
