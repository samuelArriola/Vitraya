<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="NuevaAgenda.aspx.cs" Inherits="Presentacion.trainings.NuevaAgenda" %>
        ...
        <div class="x_content">
            ...
            <div class="field item form-group justify-content-center mt-5">
                <div class="col col-6 d-flex justify-content-between">
                    ...
                    <button class="btn btn-success" id="btnCrearAgenda" type="button">Crear Agenda</button>
                </div>
            </div>
        </div>
    </div>
    <script src="js/NuevaAgendaJS.js"></script>
</asp:Content>
