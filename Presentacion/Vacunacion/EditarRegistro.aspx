<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EditarRegistro.aspx.cs" Inherits="Presentacion.Vacunacion.EditarRegistro" %>
        ...
        <div class="x_content" id="panel1">
            <div class="row justify-content-center d-flex">
                <div class="row col col-12 col-xl-11">
                    ...
                    <div class="col col-12 col-sm-3">
                        <div class="form-group">
                            <label>Condición del usuario</label>
                    ...
                    <div class="col col-12 col-sm-3 groupNaciMenor">
                        <div class="form-group">
                ...
                <div class="row justify-content-center d-flex">
                    <div class="col col-12 col-xl-11 row">
                        ...
                        <div class="col col-12 col-sm-3">
                            <div class="form-group">
                                <label>Aseguradora</label>
                                <asp:DropDownList runat="server" ID="txtAseguradoraAC" class="txtAseguradoraAC" CssClass="form-control txtAseguradoraAC">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col col-12 col-xl-11 row">
                <div class="d-flex justify-content-between col col-12 col-xl-12">
                    ...
                    <button type="button" class="btn btn-success" id="btnRegistrar">Actualizar</button>
                </div>
            </div>
        </div>
    </div>
    <script src="js/EditarRegistroJS.js"></script>
</asp:Content>
