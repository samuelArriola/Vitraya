<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VerAuditoriasInternas.aspx.cs" Inherits="Presentacion.Auditorias.VerAuditoriasInternas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table-inf">
                        ...
                        <tr>
                            <td>Responsable de la auditoria</td>
    ...
    <script src="js/VerAuditoriasInternasJS.js"></script>
</asp:Content>
