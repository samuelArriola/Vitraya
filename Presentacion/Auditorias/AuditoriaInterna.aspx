<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AuditoriaInterna.aspx.cs" Inherits="Presentacion.PlanAccion.AuditoriaInterna" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div class="x_content">
            <div class="row justify-content-center">
                <div class="col col-10">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Responsable de la auditoria</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <asp:DropDownList runat="server" ID="ddlResponsableHall" CssClass="form-control" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <!-- Fin de la Sección de Hallazgos-->
    ...
    <script src="js/AuditoriaInternaJS.js"></script>
</asp:Content>
