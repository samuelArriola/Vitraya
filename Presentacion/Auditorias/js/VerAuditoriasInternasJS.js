             ...
             <div class="col-12 col-sm-6 col-md-4 col-lg-3  card-container p-1">
                <div class="card-flip">
                    <div class="card-flip-front">
                        ...
                        <div>
                            <h2 class="card-title">Auditoria realizada por: ${auditoria.StrResponsable} el dia ${moment(auditoria.DtmFecha).format("dddd,  D [de] MMMM [de] YYYY")}</h2>
                        </div>
                       <div class="btn-view">
...
function GetAuditorias() {
    ejecutarajax("VerAuditoriasInternas.aspx/GetAuditoriasInternas", {}, cargarAuditoriasExternas)
}
