<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPassword.aspx.cs" Inherits="Generales_1._0.Log_in.NewPassword" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #background {
            ...
            padding: 0;
            margin: 0;
            background-color: rgba(200, 198, 198, 0.95);
                            ...
                            <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" align="center" Style="display: none; height: 50%; width: 80%">
                                <div class="col-md-12 col-sm-12">
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <div class="col-md-12 col-sm-12" id="solicitar" runat="server" style="-webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;">
                                                <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" placeholder="Nueva Contraseña" TextMode="Password"></asp:TextBox>
                                                <br />
                                                <br />
                                                <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Repita la contraseña" TextMode="Password"></asp:TextBox>
                                                <br />
                                                <br />
                                                ...
                                                <br />
                                                <br />
                                                <asp:Button ID="Button2" runat="server" Text="Cambiar Contraseña" CssClass="btn btn-info" OnClick="Button2_Click" />
                                            </div>
                                            <div class="col-md-12 col-sm-12" runat="server" id="contraseña">
                                                <div class="col-md-12 col-sm-12 " id="Div1" runat="server">
                                                    <div class="alert alert-success" role="alert">
                                                        <h4 class="alert-heading">Success!</h4>
                                                        <asp:Label ID="Label2" runat="server" Text="Contraseña cambiada con exito"></asp:Label>
                                                        <hr>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="0" AssociatedUpdatePanelID="UpdatePanel3">
                                        <ProgressTemplate>
                                            ...
                                            <div class="overlayContent">
                                                <h2>Cambiando contraseña por favor espere...</h2>
                                ...
                                <br />
                                <div class="col-md-12 col-sm-12">
                                    <asp:LinkButton ID="LinkButton2" runat="server" Style="color: transparent; cursor: auto"></asp:LinkButton>
                                    <asp:Button ID="Button3" runat="server" Text="Cerrar" CssClass="btn btn-success" OnClick="Button3_Click" />
                                </div>
                            </asp:Panel>
