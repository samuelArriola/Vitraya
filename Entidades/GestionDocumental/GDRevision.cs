...
{
    public class GDRevision
    {
        public  const int NOVISTO = 0, RECHAZADO = 2, APROBADO = 1;

        private int         intOidGDRevision, 
                            intOidGDDocumento, 
                            intOidRevisor, 
                            intEstado;
        ...
        public int IntOidGDRevision { get => intOidGDRevision; set => intOidGDRevision = value; }
